    ...
    <main className={styles.page}>
      ...
      <section className={styles.container}>
        <div className="mb-12">
            ...
            <h1 className="text-4xl font-black text-slate-900">{exam.name} <span className="text-indigo-600">Mocks</span></h1>
            <p className="text-slate-500 mt-2">Choose your target paper to begin the simulation.</p>
        </div>
