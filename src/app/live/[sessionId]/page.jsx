    ...
    <AdminProvider>
      <Suspense fallback={<div className="flex items-center justify-center p-40 animate-pulse text-slate-300">📡 Loading Mission...</div>}>
        <SessionProvider sessionId={sessionId}>
          <div className={`min-h-screen flex flex-col items-center justify-start pt-8 pb-12 px-4 sm:px-6 lg:px-8 transition-colors duration-500 ${patternClasses[engineTheme] || "theme-pattern"} ${engineTheme === 'midnight' ? 'midnight-pattern' : ''} ${themeClasses[engineTheme] || themeClasses.indigo}`}>
